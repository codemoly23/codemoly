...
const Card: React.FC<CardProps> = ({ 
  ...
  const variants = {
    ...
    glass: 'bg-white/10 dark:bg-gray-900/10 backdrop-blur-lg border border-white/20 dark:border-gray-700/20'
  };

  const hoverEffects = hover ? 'hover:shadow-2xl hover:-translate-y-1 cursor-pointer' : '';
